...
import uk.gov.hmrc.residencenilratebandcalculator.views.html.type_of_settlor

class TypeOfSettlorController @Inject()(override val appConfig: FrontendAppConfig,
                                        val messagesApi: MessagesApi,
                                        override val sessionConnector: SessionConnector,
                                        override val navigator: Navigator) extends SimpleControllerBase[String] {

  override val controllerId = Constants.typeOfSettlorId
  ...
  override def view(form: Option[Form[String]], userAnswers: UserAnswers)(implicit request: Request[_]) = {
    type_of_settlor(appConfig, form)
  }
}
